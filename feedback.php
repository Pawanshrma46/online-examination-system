        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <img src="./image/pk.jpg" width=100 height=100 alt="#" class="img-rounded">
                        </div>
                        <div class="col-md-5">
                            <a href="https://www.facebook.com/profile.php?id=100030830572650"
                                style="color:#202020; font-family:'typo' ; font-size:18px"
                                title="Find on Facebook">Pawan Kumar Badhai </a>
                            ...
                            <h4 style="font-family:'typo' ">Nepalgunj Collage of Management & Technology , Nepalgunj
                            </h4>
                        </div>
                    </div>
                    </p>
