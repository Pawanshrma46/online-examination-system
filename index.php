                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <select id="gender" name="gender" placeholder="Enter your gender"
                                    class="form-control input-md">
                                    <option value="Male">Select Grade</option>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" style="font-family:'typo' "><span style="color:orange">Developer</span>
                    </h4>
                </div>

                <div class="modal-body">
                    <p>
                    <div class="row" id="pkimg">
                        <div class="col-md-4">
                            <img src="./image/pk.jpg" width="135px">
                        </div>
                        <div class="col-md-5">
                            <a href="#" style="color:#202020; font-family:'typo' ; font-size:18px"
                                title="Find on Facebook">Pawan Sharma</a>
                            <h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+977 9812414877
                            </h4>
                            <h4 style="font-family:'typo' ">pawanshrma46@@gmail.com</h4>
                            <h4 style="font-family:'typo' ">Nepalgunj Collage of managment and Technology , Nepalgunj
                            </h4>
                        </div>
                    </div>
                    </p>
